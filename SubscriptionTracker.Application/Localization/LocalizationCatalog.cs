...
public static class LocalizationCatalog
{
    private static readonly IReadOnlyDictionary<string, string> Ru = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["ImportPreviewSummaryFormat"] = "Обработано строк: {0}\nБудет создано подписок: {1}\nБудет обновлено подписок: {2}\nБудет создано категорий: {3}\nБудет пропущено строк: {4}",
        ["ImportResultSummaryFormat"] = "Обработано строк: {0}\nСоздано подписок: {1}\nОбновлено подписок: {2}\nСоздано категорий: {3}\nПропущено строк: {4}\nНе импортировано по выбору: {5}",
        ...
        ["ImportPreviewWindowTitle"] = "Предварительный просмотр импорта",
        ["ImportPreviewSubtitle"] = "Проверьте, какие подписки будут созданы, обновлены или пропущены перед применением файла.",
        ["ImportPreviewWarningsTitle"] = "Предупреждения и пропуски",
        ["ImportPreviewRowsTitle"] = "Строки файла",
        ["ImportPreviewActionColumn"] = "Действие",
        ["ImportPreviewConfirm"] = "Импортировать",
        ["ImportPreviewSelectAll"] = "Выбрать все",
        ["ImportPreviewSelectedFormat"] = "Выбрано: {0} из {1}",
        ["ImportPreviewActionCreate"] = "Создать",
        ["ImportPreviewActionUpdate"] = "Обновить",
        ["ImportPreviewActionSkip"] = "Пропустить",
        ["ImportPreviewNewCategoryNote"] = "Будет создана новая категория.",
        ["ImportPreviewFallbackName"] = "Строка {0}",
        ["ImportRollbackUnavailableTitle"] = "Откат недоступен",
        ["ImportRollbackUnavailableMessage"] = "В журнале нет импортов, которые можно отменить.",
        ["ImportRollbackConfirmTitle"] = "Отменить последний импорт",
        ["ImportRollbackConfirmMessage"] = "Файл: {0}\nВремя: {1:dd.MM.yyyy HH:mm}\nПрименено строк: {2}\nСоздано подписок: {3}\nОбновлено подписок: {4}\nСоздано категорий: {5}\n\nОтменить этот импорт?",
        ["ImportRollbackCompletedTitle"] = "Импорт отменен",
        ["ImportRollbackCompletedMessage"] = "Файл: {0}\nУдалено подписок: {1}\nВосстановлено подписок: {2}\nУдалено категорий: {3}",
        ["ImportRollbackFailedTitle"] = "Ошибка отката импорта",
        ["ImportHistoryRowsFormat"] = "Строк применено: {0}",
        ["ImportHistoryCountsFormat"] = "Создано: {0} · Обновлено: {1} · Категорий: {2}",
        ["ImportHistoryRollbackAvailable"] = "Откат доступен.",
        ["ImportHistoryRollbackBlocked"] = "Откат недоступен.",
        ["ImportRollbackBlockedByNewerImport"] = "Откат недоступен: более новый импорт \"{0}\" от {1:dd.MM.yyyy HH:mm} уже изменил связанные данные.",
        ["ImportEntryCreatedSubscription"] = "Создана подписка",
        ["ImportEntryUpdatedSubscription"] = "Обновлена подписка",
        ["ImportEntryCreatedCategory"] = "Создана категория",
        ["ImportSessionNotFoundTitle"] = "Сессия импорта не найдена",
        ["ImportSessionNotFoundMessage"] = "Выбранная сессия импорта больше недоступна.",
        ["ImportSessionDetailsTitle"] = "Детали импорта",
        ["ImportSessionDetailsMessage"] = "Файл: {0}\nВремя: {1:dd.MM.yyyy HH:mm}\nПрименено строк: {2}\nСоздано подписок: {3}\nОбновлено подписок: {4}\nСоздано категорий: {5}\nОткат: {6}\n\nИзменения:\n{7}",
        ["ImportSessionDetailsNoEntries"] = "Нет зафиксированных изменений.",
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["ImportPreviewSummaryFormat"] = "Rows processed: {0}\nSubscriptions to create: {1}\nSubscriptions to update: {2}\nCategories to create: {3}\nRows to skip: {4}",
        ["ImportResultSummaryFormat"] = "Rows processed: {0}\nSubscriptions created: {1}\nSubscriptions updated: {2}\nCategories created: {3}\nRows skipped: {4}\nNot imported by selection: {5}",
        ...
        ["ImportPreviewWindowTitle"] = "Import preview",
        ["ImportPreviewSubtitle"] = "Review which subscriptions will be created, updated, or skipped before applying the file.",
        ["ImportPreviewWarningsTitle"] = "Warnings and skipped rows",
        ["ImportPreviewRowsTitle"] = "File rows",
        ["ImportPreviewActionColumn"] = "Action",
        ["ImportPreviewConfirm"] = "Import now",
        ["ImportPreviewSelectAll"] = "Select all",
        ["ImportPreviewSelectedFormat"] = "Selected: {0} of {1}",
        ["ImportPreviewActionCreate"] = "Create",
        ["ImportPreviewActionUpdate"] = "Update",
        ["ImportPreviewActionSkip"] = "Skip",
        ["ImportPreviewNewCategoryNote"] = "A new category will be created.",
        ["ImportPreviewFallbackName"] = "Row {0}",
        ["ImportRollbackUnavailableTitle"] = "Rollback unavailable",
        ["ImportRollbackUnavailableMessage"] = "There are no import sessions available to undo.",
        ["ImportRollbackConfirmTitle"] = "Undo last import",
        ["ImportRollbackConfirmMessage"] = "File: {0}\nTime: {1:g}\nApplied rows: {2}\nSubscriptions created: {3}\nSubscriptions updated: {4}\nCategories created: {5}\n\nUndo this import?",
        ["ImportRollbackCompletedTitle"] = "Import rolled back",
        ["ImportRollbackCompletedMessage"] = "File: {0}\nSubscriptions deleted: {1}\nSubscriptions restored: {2}\nCategories deleted: {3}",
        ["ImportRollbackFailedTitle"] = "Import rollback error",
        ["ImportHistoryRowsFormat"] = "Applied rows: {0}",
        ["ImportHistoryCountsFormat"] = "Created: {0} · Updated: {1} · Categories: {2}",
        ["ImportHistoryRollbackAvailable"] = "Rollback is available.",
        ["ImportHistoryRollbackBlocked"] = "Rollback is unavailable.",
        ["ImportRollbackBlockedByNewerImport"] = "Rollback is blocked: a newer import \"{0}\" from {1:g} already changed related data.",
        ["ImportEntryCreatedSubscription"] = "Created subscription",
        ["ImportEntryUpdatedSubscription"] = "Updated subscription",
        ["ImportEntryCreatedCategory"] = "Created category",
        ["ImportSessionNotFoundTitle"] = "Import session not found",
        ["ImportSessionNotFoundMessage"] = "The selected import session is no longer available.",
        ["ImportSessionDetailsTitle"] = "Import details",
        ["ImportSessionDetailsMessage"] = "File: {0}\nTime: {1:g}\nApplied rows: {2}\nCreated subscriptions: {3}\nUpdated subscriptions: {4}\nCreated categories: {5}\nRollback: {6}\n\nChanges:\n{7}",
        ["ImportSessionDetailsNoEntries"] = "No tracked changes were recorded.",
        ["ImportTemplateDefaultFileName"] = "subscription-import-template.xlsx",
